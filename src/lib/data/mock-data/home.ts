...
export const mockCommunityItems = [
	{
		id: 1,
	...
	},
	{
		...
		address: 'Seoul & Busan',
		description:
			'Discover and share the best Korean food spots, recipes, and culinary experiences.',
	...
	},
	{
		...
		address: 'Seoul',
		description:
			'Join us to explore hidden gems and famous spots in Seoul with fellow adventurers.',
